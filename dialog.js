...
module.exports = dialog
    ...
    .onDefault([sendInstructions/*, handleSentInstructions*/]);
...
function sendInstructions(session, results, next) {
    ...
    builder.Prompts.choice(session, 'What information are you looking for?', options, { listStyle:style });
    next(); 
}

// function handleSentInstructions(session, results, next) {
//     var instruction = results.response.entity;
//     if (instruction == 'Load Profile') {
//         confirmUsername(session, results, )
//     }
// }
